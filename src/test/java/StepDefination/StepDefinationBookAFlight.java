...
public class StepDefinationBookAFlight {
	WebDriver driver;
	...
	public void click_on_flights_to_book_a_flight() {
	...
	public void enter_details_to_book_flight() {
	...
	public void user_successfully_booked_flight() {
